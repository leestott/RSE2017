...
#install requirements.txt dependancies in Visual Studio simply select solution right click on your Python Enviroment and select install from requirements.txt
...
SHOW_ENGAGED = False
SHOW_IDENTITY = True
#special groups url for pretrained faces
OXFORD_GROUPS_URL = "https://api.projectoxford.ai/face/v1.0/persongroups"
#if you dont have a Kinect change this to False
USE_KINECT = True

#Number of calls to Cognitive Services http://aka.ms/cognitive API for the free services you get 2million free calls
...
CUSTOM_PYTHON_VERSIONS = {
    # see https://github.com/Microsoft/Cognitive-Face-Python/blob/master/cognitive_face/person_group.py 
    #Group Name MSFT-ies
    #Members then decription 
    #example "Bill: "OverflowError: too tall",
...
class BodyGameRuntime(object):
    def __init__(self):
        ...
        #simply change name of logos required on screen output
        self.python_logo_image = pygame.image.load('RSE.png')
        self.msft_logo_image = pygame.image.load('microsoftlogo.png')

        self.bg_color = pygame.Color(2, 5, 5)
    ...
    def process_soylent(self, frame, bodies):
        ...
        if RATE_LIMIT_PER_MINUTE:
            time.sleep(30 / RATE_LIMIT_PER_MINUTE)
    ...
    def draw_curtain(self):
        ...
        text = font.render(
            "Research Software Engineering Conference 2017",
            True,
